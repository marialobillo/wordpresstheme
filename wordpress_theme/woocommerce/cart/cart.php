...
<tbody>
		...
		if ( sizeof( $woocommerce->cart->get_cart() ) > 0 ) {
			foreach ( $woocommerce->cart->get_cart() as $cart_item_key => $values ) {
				...
				if ( $_product->exists() && $values['quantity'] > 0 ) {
					?>
					<tr class = "cart_table_item span10 panel-con-sombra">
						...
						<td class="product-image">
							<?php
								...
								//$thumbnail  = do_action( 'woocommerce_before_single_product_summary' );
		...
		?>
		<tr>
			<td class='linea-total'>
				
			
			<div class='linea span10'></div>
			</td>
		</tr>
		<tr class='celda span11'>
			...
			<td class="actions">
					...
					<?php } ?>
					 ...
					 <input type="submit" class="botones-carro" name="proceed" value="<?php _e( 'Proceed to Checkout &rarr;', 'woocommerce' ); ?>" />
					
					<input type="submit" class="botones-carro" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" />
