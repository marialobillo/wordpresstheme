...
if ( $attachment_ids ) {
	...
	<div class="thumbnails"><?php
		...
		$columns = apply_filters( 'custom_product_large_thumbnail_size', 3 );
		...
		foreach ( $attachment_ids as $attachment_id ) {
			...
			$image       = wp_get_attachment_image( $attachment_id, apply_filters( 'single_product_small_thumbnail_size', 'medium' ) );
