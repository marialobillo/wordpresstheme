...
?>
<div class="span10 singlepanel panel-con-sombra">
	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="botones-carro" name="woocommerce_checkout_place_order" id="place_order" value="' . $order_button_text . '" />' );
			?>
