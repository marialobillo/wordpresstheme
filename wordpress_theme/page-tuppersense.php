...
include_once('class.phpmailer.php');
 ...
 //my_contact_form_generate_response("error", $missing_content);
  ...
  if(isset($_POST['email'])){
    ...
    $mail->AddAddress($destino, '5sentidos Tuppersense');
    $mail->SetFrom($email, $nombre);
    
    $mail->CharSet = "UTF-8";

    $mail->Subject  = 'Sessiones Tuppersense';
      ...
      <div class='content-page'>
          ...
          <div class="respond">
          	...
          	<form method='post' action='<?php the_permalink(); ?>'>
          		<span>Nombre del organizador/a</span><br>
          		...
          		<span>Direccion dónde se organizará</span><br>
          		<input type="text"  value="<?php echo $direccion; ?>" name='direccion' class='large'>
          		<br>
          		<div class='left'>
          			<span>Fecha deseada</span><br>
          			<input type="date"  value="<?php echo $fecha; ?>" name='fecha' class='medium'>
          		</div>
          		<div class='right'>
          			<span>Nº Personas</span><br>
